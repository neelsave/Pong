...
while True:
    ...
    if(score_a == 1):
       ...
       pen.hideturtle()
       pen.goto(0, 0)
       pen.write("player A wins Press r to restart", align="center", font=("Courier", 24, "normal"))
    ...
    if(score_b == 1):
       ...
       pen.hideturtle()
       pen.goto(0, 0)
       pen.write("player B wins press r to restart", align="center", font=("Courier", 24, "normal"))
